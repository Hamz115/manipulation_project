...
private:
    ...
    void pick_and_place() {
        ...
        const std::vector<double> PRE_GRASP_POSE{x_, y_, 0.35, -1.0, 0.00, 0.00, 0.00};
        const double x_offset = 0.015;
        const double y_offset = -0.01;  // Change this value as needed
        const std::vector<double> GRASP_POSE{x_ + x_offset, y_ + y_offset, 0.17, -1.0, 0.00, 0.00, 0.00};
        // Planning interfaces
